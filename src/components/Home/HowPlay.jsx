...
const HowPlay = () => {
  return (
    <div className="bg-[#F4F4F4]">
      <div className="main-container py-8 md:py-24">
        ...
        <div className=" hidden md:grid grid-cols-1 md:grid-cols-4 gap-10 pt-10">
          ...
          <div className="md:-mt-[41px]">
            <div className="mb-4">
              ...
              <p className="text-[#434648] text-base font-normal text-center">
                Once {`you've`} bought your tickets, wait for the raffle draw
                date to find out if {`you've`} won.
              </p>
            </div>
          ...
          <div className="">
            ...
            <div className="">
              ...
              <p className="text-[#434648] text-base font-normal text-center">
                The winning numbers or names will be announced by the raffle
                Live
              </p>
            </div>
          </div>
